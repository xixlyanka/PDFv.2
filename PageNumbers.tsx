...
import { Hash, Loader2, AlertCircle, FileText, ShieldCheck } from 'lucide-react';
...
const PageNumbers: React.FC = () => {
  ...
  const [format, setFormat] = useState<'n' | 'page n' | 'page n of m'>('n');
  ...
  const handleProcess = async () => {
    ...
    try {
        const res = await docService.addPageNumbers(file, { position, format, startFrom });
        setResult(res);
        setStatus('completed');
    } catch (e: any) {
        setError(e.message);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-20">
      <SEO 
        ...
        description="Add page numbers to PDF documents online. Custom position and format."
      />
      
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
            <div className="text-center lg:text-left mb-8">
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white sm:text-4xl">Add Page Numbers</h1>
                <p className="mt-3 text-lg text-gray-500 dark:text-gray-400">Insert page numbers into your PDF document.</p>
            </div>
            ...
            <div className="mb-6 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 flex items-start gap-3">
                ...
                <p className="text-sm text-green-700 dark:text-green-300">Page numbers are added directly in your browser.</p>
                </div>
            </div>
                ...
                <div className="space-y-6 animate-fade-in">
                    ...
                    {status === 'processing' && (
                        <div className="text-center py-10">
                            ...
                            <p className="text-gray-600 dark:text-gray-300">Adding numbers...</p>
                        </div>
                    )}
                    ...
                    {status === 'error' && (
                        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 flex items-start space-x-3">
                            ...
                            <div>
                                <h4 className="text-sm font-medium text-red-800 dark:text-red-400">Process Failed</h4>
