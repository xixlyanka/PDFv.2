...
const Flatten = lazy(() => import('./Flatten'));
const PageNumbers = lazy(() => import('./PageNumbers'));
const Repair = lazy(() => import('./Repair'));
const Sign = lazy(() => import('./Sign'));
const Grayscale = lazy(() => import('./Grayscale'));
const OCR = lazy(() => import('./OCR'));
const ExtractImages = lazy(() => import('./ExtractImages'));
const EditMetadata = lazy(() => import('./EditMetadata'));
const HtmlToPdf = lazy(() => import('./HtmlToPdf'));
const PdfToPdfA = lazy(() => import('./PdfToPdfA'));
const InvoiceGenerator = lazy(() => import('./InvoiceGenerator'));
const Redact = lazy(() => import('./Redact'));
const Guides = lazy(() => import('./Guides'));
const GuidePost = lazy(() => import('./GuidePost'));
const Admin = lazy(() => import('./Admin'));
const NotFound = lazy(() => import('./NotFound'));
const PrivacyPolicy = lazy(() => import('./StaticPages').then(module => ({ default: module.PrivacyPolicy })));
const Terms = lazy(() => import('./StaticPages').then(module => ({ default: module.Terms })));
const About = lazy(() => import('./StaticPages').then(module => ({ default: module.About })));
